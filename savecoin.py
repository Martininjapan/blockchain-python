...
class Blockchain:
   ...
   def is_chain_valid(self,chain):
       ...
       while block_index < len(chain):
           ...
           if block['previous_index']!= self.hash(previous_block):
               return False
...
node_adress = str(uuid4()).repalace('-','')
...
def add_transaction():
    ...
    if not all (key in json for key in transaction_keys):
        return 'Some elements of the transaction are missing', 4OO
